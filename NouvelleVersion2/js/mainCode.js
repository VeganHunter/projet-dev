...
var ImageWidth = coeff*radiusSun/au * 500 * (2.7/1.5);
var sunsvg = container.append("svg:image")
	.attr("x", -ImageWidth)
	.attr("y", -ImageWidth)
	.attr("class", "sun")
	.attr("xlink:href", "sun2.png")
...
ImageWidth = coeff*radiusSun/au * 500 * (2.7/1.5);
sunsvg.attr("x", -ImageWidth)
	.attr("y", -ImageWidth)
	.attr("width", ImageWidth*2)
	.attr("height", ImageWidth*2);
}
